...
%   Each static function in the class should return an anonymous 
%   function which takes in desired and actual states and returns 
%   control outputs (forces/torques)
